...
\backmatter
\chapterstyle{BackMatterChapterStyle}

%% Pull bookmarks out of the "part"
\bookmarksetup{startatroot}

%% List of Acronyms
\printacronyms

% Отдельный список сокращений (tag=abbrev)
\chapter{Список сокращений}
\printabbreviations[heading=none]

% Отдельный список терминов (tag=term)
\chapter{Глоссарий}
\printglossaryterms[heading=none]
